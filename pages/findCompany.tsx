...
import { HiMegaphone, HiOutlineArrowLongRight } from "react-icons/hi2";
        ...
        <>
            ...
            <section className="pb-16">
                <div className="mx-auto max-w-7xl px-8 md:px-6">
                    <div className="mb-5 sm:mb-10 py-5 mt-5">
                        <h1 className="text-2xl font-bold text-slate-700 sm:text-3xl">Recommanded companies</h1>
                        <h1 className="text-xs font-bold text-slate-300">Based on your profile, company preference, and recend activity</h1>
                    </div>
                    <div className="mx-auto max-w-7xl px-2 md:px-2">
                        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4 xl:gap-6">
                            
                            <div className="group flex cursor-pointer flex-col rounded-xl gap-y-5 border border-gray-500/10 bg-white px-5 py-8 shadow-lg shadow-slate-300 duration-200 hover:bg-blue-500">
                                <div className="flex-wrap text-left">
                                    <div className="grid-cols-2 flex gap-8 justify-between">
                                        <div>
                                ...
                                <a
                                    href="#"
                                    className="mr-2 rounded-full border-[1px] border-orange-400 px-3 w-2/5 py-1 text-sm text-orange-600"
                                >
                                    Services
                                </a>
                            </div>
